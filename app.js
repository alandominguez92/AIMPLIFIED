(function () {
  ...
  // The Odds API returns full team names; the ticker shows abbreviations. Same
  // spellings the boards use (MLB's own), so a club cannot read one way in the
  // ticker and another in the row beneath it.
  const TEAM_ABBR = {
